...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Apr 2024 pada 11.41
...
(77, 'Rudi', 'L', '2002-01-30', 'Single', 'Mesin', '1462200012', NULL, '2023/2024', 'Pelajar', 'Jl. Kaliurang No. 20', NULL, NULL, 'Yogyakarta', 'DI Yogyakarta', '08543210987', 'rudi@example.com', NULL),
...
(129, 'Bertha', '', '2005-01-21', '', '', '1722200002', '', '2024/2025', 'Sales', 'Bungurasih', NULL, NULL, 'Bungurasih', 'Bungurasih', '5678', 'bertha@gmail.com', NULL),
(130, 'Bertha Sianturi', '', '2024-04-11', '', '', '1712200002', '', '', 'Sales', 'Bungurasih', NULL, NULL, 'Bungurasih', 'Bungurasih', '000000', 'bertha@gmail.com', NULL),
(131, 'Daniel Kurnia Putra', 'L', '2024-04-24', 'single', 'informatika', '1462200030', 'SMK', '2023/2024', 'Sales', 'Sales', NULL, NULL, 'Sales', 'Sales', 'Sales', 'Sales', NULL),
...
(1, 0, '', '255', 'Fridy Mandita, S.Kom., M.Sc'),
(2, 0, '', '23', 'Fridy Mandita, S.Kom., M.Sc'),
(3, 0, '', '', 'Fridy Mandita, S.Kom., M.Sc'),
(4, 0, '', '', 'Fridy Mandita, S.Kom., M.Sc'),
(5, 1462200006, '', '23', 'Fridy Mandita, S.Kom., M.Sc'),
...
--
ALTER TABLE `tbl_mhsiswa`
  MODIFY `id_mahasiswa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
